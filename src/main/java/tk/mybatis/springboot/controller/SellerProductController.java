...
import tk.mybatis.springboot.form.ProductForm;
...
public class SellerProductController {
    ...
    public ModelAndView list(@RequestParam(value = "page", defaultValue = "1") Integer page,
        ...
        productInfo.setPage(page - 1);
        productInfo.setRows(size);
        List<ProductInfo> productInfoPage = productService.findAll(productInfo);
        map.put("productInfoPage", new PageInfo<ProductInfo>(productInfoPage));
    ...
    public ModelAndView index(@RequestParam(value = "productId", required = false) String productId,
        ...
        List<ProductCategory> categoryList = productCategoryService.getAll(productCategory);
